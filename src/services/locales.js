...
const TEXT = {
  [ENGLISH]: {
    ...
    appContinue: 'Your Atithy app setup is ready. Please open the Atithy app to continue and receive jobs.',
  ...
  [HINDI]: {
    ...
    appContinue: 'आपका Atithy ऐप सेटअप तैयार है। आगे जारी रखने और काम पाने के लिए कृपया Atithy ऐप खोलें।',
  ...
  [TAMIL]: {
    ...
    appContinue: 'உங்கள் Atithy செயலி அமைப்பு தயாராக உள்ளது. தொடரவும் வேலைகளைப் பெறவும் Atithy செயலியைத் திறக்கவும்.',
  ...
  [BENGALI]: {
    ...
    appContinue: 'আপনার Atithy অ্যাপ সেটআপ প্রস্তুত। চালিয়ে যেতে এবং কাজ পেতে Atithy অ্যাপ খুলুন।',
  ...
  [ODIA]: {
    ...
    appContinue: 'ଆପଣଙ୍କ Atithy ଆପ୍ ସେଟଅପ୍ ପ୍ରସ୍ତୁତ। ଜାରି ରଖିବା ଏବଂ କାମ ପାଇବା ପାଇଁ Atithy ଆପ୍ ଖୋଲନ୍ତୁ।',
  ...
  [ASSAMESE]: {
    ...
    appContinue: 'আপোনাৰ Atithy এপ ছেটআপ সাজু। আগবাঢ়িবলৈ আৰু কাম পাবলৈ Atithy এপ খোলক।',
